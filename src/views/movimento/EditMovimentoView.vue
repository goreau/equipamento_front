      ...
      <div class="column is-two-fifths">
        ...
        <div class="card">
          <header class="card-header">
            <p class="card-header-title is-centered">Edição de Movimento de Equipamento</p>
          </header>
    ...
    loadData(){
      ...
      movimentoService.getMovimento(this.movimento.id_movimento).then(
        (response) => {
          ...
          this.movimento.id_cadastro = data.id_cadastro;
          this.movimento.id_condicao = data.id_condicao;
          this.movimento.id_municipio = data.id_municipio;
          this.movimento.destino = data.destino;
          this.startCalendar();
        },
        (error) => {
          this.message =
